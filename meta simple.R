...
main <- read.table("Effectsize.csv",sep=",",header=TRUE)
#To analyze subset of data, chain above file to be called "main" and use one or more of the lines below:
effect1 <- subset.data.frame(main,main$grp1sd!="NA")
effect <- subset.data.frame(effect1,effect1$Outlier_complet=="N")
effect <- subset.data.frame(main,main$Outlier_complet=="N")
